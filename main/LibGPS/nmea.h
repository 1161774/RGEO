...
uint8_t nmea_get_message_type(const uint8_t *);
uint8_t nmea_valid_checksum(uint8_t *);
void nmea_parse_gpgga(uint8_t *, gpgga_t *);
void nmea_parse_gprmc(uint8_t *, gprmc_t *);
